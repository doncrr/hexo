...
目前在读高二，平时爱好乱折腾，玩玩gal，追追番，看漫画

这个网站使用的是hexo作为静态博客框架，主题为butterfly，主题配置套用的Fomalhaut大佬的开源项目（现在好像取消了），并在此基础上进行美（丑）化

目前本站有两个域名：
		1. http://memos.doncr.skin/（主域名）
		2.https://doncrr.github.io

第一个是通过旧手机安装ubuntu的termux实现博客和memos公网访问，主要用到ssh和rsync同步更新博客文件，negix部署网页，ubuntu中memos开启说说，mefrp内网穿透。访问速度较快，有时会挂。
